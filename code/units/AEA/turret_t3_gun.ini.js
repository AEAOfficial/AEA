exports.code = function(){ 
    client.on('message', message => {
            if (message.content.toLowerCase() === 'aeaturret_t3_gun') { 
              ...
              message.channel.send(AEAturret_t3_gun); 
	          }
	  });
const AEAturret_t3_gun = new Discord.MessageEmbed() 
   .setColor('#1500f7') 
   .setAuthor('Lemons#5444', 'https://imgur.com/6NICs3U.png') 
   .setThumbnail('https://cdn.discordapp.com/icons/606586202942079017/7eafb97b0aa80cecb8e4a9f0a7f87c21.webp?size=128')
   //.attachFiles(['./resources/AEAturret_t3_gun.png']) 
   //.setImage('attachment://AEAturret_t3_gun.png') 
   .addField('Price:  12500','__________________')
