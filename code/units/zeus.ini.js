...
const EAP = new Discord.MessageEmbed()
   ...
   .attachFiles(['./code/units/resources/172.png']) 
   .setImage('attachment://172.png') 
   .setTitle(' Z.E.U.S') 
...
const EAP = new Discord.MessageEmbed() 
   ...
   .addField('Price:  60000, uranium=3000','__________________')
   .addField('Health:  8000','__________________')
   .addField('Range:  260','__________________')
