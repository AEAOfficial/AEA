...
const extractor_reinforced_t5 = new Discord.MessageEmbed() 
   ...
   //.attachFiles(['./resources/extractor_reinforced_t5.png']) 
   //.setImage('attachment://extractor_reinforced_t5.png') 
   .addField('Health:  3750','__________________')
   .addField('Shield:  1250','__________________')
   ...
   .addField('Price:  credits=-3000','__________________')
