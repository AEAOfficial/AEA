exports.code = function(){ 
    client.on('message', message => {
            if (message.content.toLowerCase() === 'landmine') { 
              if(message.author.bot) return; 
              message.channel.send(landmine); 
	          }
	 });

const landmine = new Discord.MessageEmbed()
   .setColor('#1500f7') 
   .setAuthor('Lemons#5444', 'https://imgur.com/6NICs3U.png') 
   .setThumbnail('https://camo.githubusercontent.')
   .attachFiles(['./code/units/resources/201.png']) 
   .setImage('attachment://201.png') 
   .addField('Price:  900','\u2800')
   .addField('Health:  10','\u2800')
   .setTitle(' Landmine') 
...
const landmine = new Discord.MessageEmbed() 
   ...
   //.attachFiles(['./resources/landmine.png']) 
   //.setImage('attachment://landmine.png') 
