exports.code = function(){ 
    client.on('message', message => {
            if (message.content.toLowerCase() === 'robotcrabwater') { 
              ...
              message.channel.send(robotCrabWater); 
	          }
	 });

const robotCrabWater = new Discord.MessageEmbed()
   .setColor('#1500f7') 
   .setAuthor('Lemons#5444', 'https://imgur.com/6NICs3U.png') 
   .setThumbnail('https://camo.githubusercontent.')
   .attachFiles(['./code/units/resources/211.png']) 
   .setImage('attachment://211.png') 
   .setTitle(' Scout bot') 
...
const robotCrabWater = new Discord.MessageEmbed() 
   ...
   //.attachFiles(['./resources/robotCrabWater.png']) 
   //.setImage('attachment://robotCrabWater.png') 
   .setTitle(' Scout bot') 
   .setDescription(' -Can attack land and air \n -Can repair and reclaim \n -Can see further through fog \n -Can move over water') 
