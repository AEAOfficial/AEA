...
const experimentalMech = new Discord.MessageEmbed()
   ...
   .attachFiles(['./code/units/resources/144.png']) 
   .setImage('attachment://144.png') 
...
const experimentalMech = new Discord.MessageEmbed() 
   ...
   .addField('Price:  125000, uranium=9000','__________________')
   .addField('Health:  15000','__________________')
   .addField('Range:  310','__________________')
   .addField('Direct Damage:  700','__________________')
